        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          <div className="md:w-1/2 text-center md:text-left">
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4">
              Unlock the Power of <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-500 to-indigo-500">Devil Fruits</span>
            </h1>
            <p className="text-xl text-gray-300 mb-8">
              Premium Devil Fruits, Bloxfruit accounts, Roblox gamepass, and more at unbeatable prices!
            </p>
